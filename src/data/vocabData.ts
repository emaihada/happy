...
export const VOCAB_DATA: VocabItem[] = [
  ...
  },
  {
    ...
    pron: "일렉트릭 펄프 테스터 [iléktrik pʌlp téstər]",
    kor: "전기치수검사기",
    chapterId: "ch03",
    chapterName: "진단편 기초용어",
  ...
  },
  {
    ...
    pron: "임플란트 서저리 키트 [ímplænt sə́ːrdʒəri kìt]",
    kor: "임플란트 키트",
    chapterId: "ch10",
    chapterName: "구강악안면외과학",
  ...
  },
  {
    ...
    chapterId: "ch12",
    chapterName: "임상치위생학",
    description: "치아 인접면 사이 칫솔이 닿지 않는 얇은 틈새에 왁스칠된 실을 장입하여 음식 물질과 플라크를 실 쓸어내림질로 청소하는 위생용 구강 실"
  },
  {
    id: "ch12-05",
    eng: "Floss holder",
